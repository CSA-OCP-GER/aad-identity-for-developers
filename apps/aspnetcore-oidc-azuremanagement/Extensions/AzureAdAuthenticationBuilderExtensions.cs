...
namespace aspnetcore_oidc_azuremanagement.Extensions
{
        ...
        public class ConfigureAzureOptions : IConfigureNamedOptions<OpenIdConnectOptions>
        {
            ...
            public void Configure(string name, OpenIdConnectOptions options)
            {
                ...
                options.Events = new OpenIdConnectEvents
                {
                    ...
                    {
                        if (context.Properties.Items.ContainsKey("ConsentChallengeController"))
                        {
                            context.Response.Redirect(context.Properties.Items["ActionOnError"]);
